...
const DemoVideo = ({ className = "" }) => {
  ...
  useEffect(() => {
    ...
    if (video && isLoaded && isInView) {
      video.play().catch(console.log); // Ignore autoplay failures
    }
  }, [isLoaded, isInView]);
      ...
      >
        ...
        {isInView && (
          <video
            ...
            playsInline
            preload="metadata"
            poster="/images/demo-thumbnail.jpg" // Optional: add a poster image
        ...
        {isLoaded && showControls && (
          ...
          >
            <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 flex items-center space-x-3">
              <button
